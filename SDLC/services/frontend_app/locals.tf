locals {
  ...
  image_tag = var.common_tags.Environment == "dev" ? "${var.common_tags.Account}-sep-${var.common_tags.Environment}-frontend-app-c5b829e266101c3738365e54a5a11bbfb24c79da" : "frontend-app-c5b829e266101c3738365e54a5a11bbfb24c79da"
