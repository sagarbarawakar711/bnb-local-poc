...
resource "aws_appautoscaling_target" "ecs_logstash_target" {
...
resource "aws_appautoscaling_policy" "cpu_logstash_scale_policy" {
  ...
  depends_on = [
    aws_appautoscaling_target.ecs_logstash_target,
  ]
}

# https://www.terraform.io/docs/providers/aws/d/arn.html
data "aws_arn" "cpu_scale_policy" {
  arn = aws_appautoscaling_policy.cpu_logstash_scale_policy.arn
}

# ------------------------------------------------------------------------------

# https://www.terraform.io/docs/providers/aws/r/appautoscaling_policy.html
resource "aws_appautoscaling_policy" "memory_logstash_scale_policy" {
...
# https://www.terraform.io/docs/providers/aws/d/arn.html
data "aws_arn" "memory_logstash_scale_policy" {
  arn = aws_appautoscaling_policy.memory_logstash_scale_policy.arn
}
