locals {
  ...
  image_tag = var.common_tags.Environment == "dev" ? "${var.common_tags.Account}-sep-${var.common_tags.Environment}-frontend-api-17840239438f395268f5969f84d9a0470fe34974" : "frontend-api-17840239438f395268f5969f84d9a0470fe34974"
  ...
  resource_prefix = join("-", [var.common_tags.Account, var.common_tags.Application, var.common_tags.Environment])
  ...
  eventbridge_schedule_expression     = var.eventbridge_schedule_expression[terraform.workspace]
