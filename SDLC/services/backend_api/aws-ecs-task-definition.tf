...
#### DD Integration ######
module "backend_api_dd_container" {
...
resource "aws_ecs_task_definition" "task_definition" {
  ...
  container_definitions = jsonencode([
    module.backend_api_dd_container.fluentbit_container_definition,
    {
      ...
      "secrets" : [for key, value in local.secrets_data : {
        name      = key
        valueFrom = value
        }
      ]
      ...
      "logConfiguration" : module.backend_api_dd_container.service_container_definition_log_configuration,
      "dependsOn" : module.backend_api_dd_container.service_container_definition_depends_on,
