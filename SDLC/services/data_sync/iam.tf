...
#
# https://www.terraform.io/docs/providers/aws/d/iam_policy_document.html
data "aws_iam_policy_document" "data_sync_ecs_policy" {
...
resource "aws_iam_policy" "data_sync_ecs_policy" {
  ...
  policy = data.aws_iam_policy_document.data_sync_ecs_policy.json
}
...
resource "aws_iam_role_policy_attachment" "ecs_policy_attachment" {
  ...
  policy_arn = aws_iam_policy.data_sync_ecs_policy.arn
}
